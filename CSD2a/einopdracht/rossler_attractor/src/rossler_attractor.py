...
def AudioMain(NoteConditioning, AxisData, Tresholds = [0.5,0.5,0.2], StepsPerSecond = 5000):
    """
    Initializes the necessary functions and processes for multiprocessing playback based on timestamps derived from axis data from threshold conditioning method.
...
if __name__ == "__main__":
    ...
    AudioMain(DataTresholdConditioning, AxisData, Tresholds = [0.1, 0.1, 0.1], StepsPerSecond = 2500)
